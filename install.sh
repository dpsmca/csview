...
# Commands
##################################################
export READLINK="$(unalias -a; command -v greadlink || command -v readlink)"
...
export GETOPTS="$(unalias -a; command -v ggetopts || command -v getopts)"
export GETOPT="$(unalias -a; command -v ggetopt || command -v getopt)"
export PRINTF="$(unalias -a; command -v gprintf || command -v printf)"
export CHMOD="$(unalias -a; command -v gchmod || command -v chmod)"
export TOUCH="$(unalias -a; command -v gtouch || command -v touch)"
export UNAME="$(unalias -a; command -v guname || command -v uname)"
export XARGS="$(unalias -a; command -v gxargs || command -v xargs)"
export DATE="$(unalias -a; command -v gdate || command -v date)"
export GREP="$(unalias -a; command -v ggrep || command -v grep)"
export READ="$(unalias -a; command -v gread || command -v read)"
export ECHO="$(unalias -a; command -v gecho || command -v echo)"
export EVAL="$(unalias -a; command -v eval)"
export TYPE="$(unalias -a; command -v type)"
export TPUT="$(unalias -a; command -v tput)"
export TPUT+=" -T${TERM}"
export CURL="$(unalias -a; command -v gcurl || command -v curl)"
export AWK="$(unalias -a; command -v gawk || command -v awk)"
export SED="$(unalias -a; command -v gsed || command -v sed)"
export CUT="$(unalias -a; command -v gcut || command -v cut)"
export TEE="$(unalias -a; command -v gtee || command -v tee)"
export CAT="$(unalias -a; command -v gcat || command -v cat)"
export CP="$(unalias -a; command -v gcp || command -v cp)"
export CD="$(unalias -a; command -v gcd || command -v cd)"
export MV="$(unalias -a; command -v gmv || command -v mv)"
export RM="$(unalias -a; command -v grm || command -v rm)"
export LN="$(unalias -a; command -v gln || command -v ln)"
PYTHON3="$(unalias -a; command -v python3)"
